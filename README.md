...
- `cd server`
- `node index.js`
- select index.html from vscode editor and right click "open with live server"
...
**Use [Live Server](https://marketplace.visualstudio.com/items?itemName=ritwickdey.LiveServer), do not load your files directly into the browser**
...
- Also, present the company stock price, and changes in percentages 
- if the change is negative, the changes in percentages should be in light green, else in red.
...
- Use [```Chart.js``` | Open source HTML5 Charts](https://www.chartjs.org/) for your website to present this data in a chart (read the documentation, understand how to use it, and how to pass the data from the stock price history endpoint)
...
[Node.js Tutorial for Beginners: Learn Node in 1 Hour | Mosh](https://charcha.xyz/l/Ln3QYtMvpKEWGhXHZzfJ)
[Node.js rial - Intro to Node.js (Level 1)](https://charcha.xyz/l/oDDBOr9sRF81jVFg1gn1)
[Express.js Tutorial: Build RESTful APIs with Node and Express | Mosh](https://charcha.xyz/l/lzDP4xFNxOl33iLzc5dh)
[MongoDB in Tuto18 Minutes - Intro to MongoDB](https://charcha.xyz/l/awQL8lKuK4fToGjnz2sl)
[MongoDB Node.js Driver Documentation](https://mongodb.github.io/node-mongodb-native/3.5/)

All of the videos are provided to you in [charcha.xyz](https://charcha.xyz), you can ask there questions on top of the youtube videos. You can send the link to your teacher or classmates, to get them to answer your question.

Install Mongodb Locally: Install [MongoDB](https://docs.mongodb.com/manual/installation/)
Explore Mongodb through a UI: [Compass](https://www.mongodb.com/products/compass)
